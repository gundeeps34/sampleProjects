        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {isRegister && (
              <>
                <TextField
                  ...
                  sx={{ gridColumn: "span 2" , width: '250px', left: '50px'}}
                />
                <TextField
                  label="Last Name"
                  onBlur={handleBlur}
                  ...
                  sx={{ gridColumn: "span 2" , width: '250px', left: '-100px'}}
                />
                {/* <Box
                  gridColumn="span 4"
            ...
            <TextField
              ...
              sx={{ gridColumn: "span 4" , width: '530px', left: '50px' }}
            />
            <TextField
              label="Password"
              type="password"
